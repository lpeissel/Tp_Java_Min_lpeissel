                                ...
                                <c:forEach items="${ listUsers }" var="user">
										<tr>
											...
											<a class="btn btn-primary"
												...
												href="${pageContext.request.contextPath}/users/modify?id=${user.idClient}" > <i
													class="fa fa-edit"></i>
											</a>
												
												<button class="btn btn-danger" value="${user.idClient}" id="idClient" name="idClient" type="submit"> <i
													class="fa fa-trash"></i>
											</button> 
												</form>
												</td>
