											...
											<td>
												<form action="/rentmanager/cars" method="post">
													...
													<a class="btn btn-success enable"
														href="${pageContext.request.contextPath}/cars/modify?id=${car.idVehicle}">
														<i class="fa fa-edit"></i>
													</a>
													<button class="btn btn-danger" value="${vehicle.idVehicle}"
														id="idVehicle" name="idVehicle" type="submit">
